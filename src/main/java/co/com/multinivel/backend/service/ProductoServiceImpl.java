...
public class ProductoServiceImpl implements ProductoService {
	...
	public List<ProductoDTO> listarParaDistribuidor(String tipoProducto, String distribuidor) throws MultinivelServiceException {
		List<ProductoDTO> lista = null;
		try {
			lista = this.productoDAO.listarParaDistribuidor(tipoProducto, distribuidor);
		} catch (MultinivelDAOException e) {
			throw new MultinivelServiceException(e.getMessage(), getClass());
		}
		return lista;

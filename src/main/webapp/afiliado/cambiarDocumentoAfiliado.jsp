...
<body>
	<div align="center">
		...
		<form name="forma" action="AfiliadoFrontController" method="post">
			...
			<div align="center" class="titulo">CAMBIAR DOCUMENTO DE UN
				AFILIADO</div>
			<div align="left">
 ...
 Código Actual Empresario: <input name="codigoEmpresario" type="text"
						size="30" />

 Nuevo Código Empresario: <input name="nuevoCodigoEmpresario"
						type="text" size="30" />

					<a href="javascript:cambiarDocumentoAfiliado();">Cambiar
						Documento Afiliado</a>
				</c:if>

...
<div align="center">
	<form name="forma" action="AfiliadoFrontController" method="post">
		...
		<div align="center" class="titulo">BORRAR AFILIADO</div>
		<div align="left">
				...
				<div id="accordion">
					...
					<div id="datosPersonales">
						...
						<table width="100%">
							<tr align="left">
								...
								<td width="25%">Fecha de Nac: <input name="fechaNacimiento"
									type="text" class="ui-datepicker-calendar" id="fecha" size="15"
									value="<c:out value='${afiliado.fechaNacimiento}'/>" /></td>
							</tr>
							<tr align="left">
								...
								<td>Profesion u Ocupación:<input name="profesion"
									type="text" size="15"
									value="<c:out value='${afiliado.ocupacion}'/>" /></td>
							...
							<tr align="left">
								...
								<td>Celular o Beeper: <input name="celular" type="text"
									size="10" value="<c:out value='${afiliado.celular}'/>" />
								</td>
								<td>E-mail: <input name="email" type="text" size="20"
									maxlength="50" value="<c:out value='${afiliado.email}'/>" /></td>
								<td colspan="2">Nomb Conyugue/Tutor: <input
									name="nombreConyugue" type="text" size="15"
									value="<c:out value='${afiliado.nombreConyugue}'/>" />
								</td>
							</tr>
						</table>
					</div>
					...
					<div>
						<table width="100%">
							...
							<tr>
								<td width="50%">Tipo de cta. Ahorro <input
							...
							<tr>
								<td width="50%">Nombre: <input name="nombreTitular"
									type="text" size="30" maxlength="50"
									value="<c:out value='${afiliado.nombreTitularCta}'/>" />
								</td>
								<td width="50%">C.C. No.<input name="documentoTitular"

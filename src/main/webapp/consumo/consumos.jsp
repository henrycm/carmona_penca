...
<table width="80%" >
  ...
  <tr>
    ...
    <td><input maxlength="3" size="3" name="cantidad_<c:out value='${producto.codigo}'/>_<c:out value='${producto.precioDistribuidor}'/>_<c:out value='${producto.nombreProducto}'/>"></td>
...
<table width="80%">
  ...
  <tr>
    ...
    <td><input maxlength="3" size="3" name="cantidad_<c:out value='${producto1.codigo}'/>_<c:out value='${producto1.precioDistribuidor}'/>_<c:out value='${producto1.nombreProducto}'/>"></td>

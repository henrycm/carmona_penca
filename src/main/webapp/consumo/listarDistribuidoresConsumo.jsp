			...
			<form name="liquidacion" method="post" action="ControlLiquidacion">
				...
				<div class="btn-group">
					<a class="btn btn-sm btn-default"
						href="javascript:generarReporteConsumoTotalRed();">Generar
						Reporte</a>
				</div>
				<table align="center" class="tbl-lista" width="70%">
					<tr>
						<th colspan="3">Consultar Lista de consumos totales
							registrados por el distribuidor</th>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2">Distribuidor: <select
							name="distribuidor">

		...
		<div>
			<ul>
				<c:forEach var='producto'   items='${listaAlimentos}'>
					<li><c:out value='${producto.nombreProducto}'/> - Precio:<c:out value='${producto.precioAfiliado}'/> <span align="rigth"><input name="cantidad_<c:out value='${producto.codigo}'/>_<c:out value='${producto.precioAfiliado}'/>" type="text" size="5"   onclick="javascript:chequearProducto(this)" maxlength="3" /> </Span></li> 
				</c:forEach>
		...
		<div>
			<ul>
				<c:forEach var='producto1'   items='${listaPiel}'>
					<li><c:out value='${producto1.nombreProducto}'/> - Precio:<c:out value='${producto1.precioAfiliado}'/> <span align="rigth"><input name="cantidad_<c:out value='${producto.codigo}'/>_<c:out value='${producto.precioAfiliado}'/>" type="text" size="5"    onclick="javascript:chequearProducto(this)" maxlength="3" /> </Span></li> 
				</c:forEach>
			</ul>
		</div>
		...
		<div>
			<ul>
				<c:forEach var='producto2'   items='${listaCapilar}'>
					<li><c:out value='${producto2.nombreProducto}'/> - Precio:<c:out value='${producto2.precioAfiliado}'/> <span align="rigth"><input name="cantidad_<c:out value='${producto.codigo}'/>_<c:out value='${producto.precioAfiliado}'/>" type="text" size="5"    onclick="javascript:chequearProducto(this)" maxlength="3"/> </Span></li> 
				</c:forEach>
			</ul>
		</div>

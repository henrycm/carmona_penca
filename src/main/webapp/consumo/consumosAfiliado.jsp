...
<div align="right" id="opcion">
		<a href="javascript:vistaPreliminarPedido();">Vista Preliminar del consumo</a>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</div>
<p>&nbsp;</p>
...
<table width="53%">
  ...
  <input name="fechaConsumo" type="hidden" size="20" value="<c:out value="${fechaConsumo}"/>" />
</table>
Linea de Alimentos
<table width="80%" >
  <tr class="tabla">
  ...
  <tr>
   ...
   <td><input maxlength="3" size="3" name="cantidad_<c:out value='${producto.codigo}'/>"   onclick="javascript:chequearProducto(this)"/></td>
    <td><input type="checkbox" value="<c:out value='${producto.codigo}'/>" name="producto" />
        <input type="hidden"  value="<c:out value='${producto.precioAfiliado}'/>_<c:out value='${producto.nombreProducto}'/>"  name="datos_<c:out value='${producto.codigo}'/>"  /> 
     </td>
</c:forEach>

...
function calcular_edad(fecha){ 
  ...
  /**  function cargarPeriodo(periodo){
    	...
    	datos = periodo.split("/");
    	mes =parseInt(datos[0]);
    	year=parseInt(datos[1]);
    	...
    	if(mes >=1 || mes <=5){
    		...
    		if(mes==1){
    			...
    			forma.mes.options[0]= new Option();
    			forma.mes.options[0].text="11";
    			forma.mes.options[0].value="11";
       			forma.mes.options[1]= new Option();
    			forma.mes.options[1].text="12";
    			forma.mes.options[1].value="12";
       			forma.mes.options[2]= new Option();
    			forma.mes.options[2].text="01";
    			forma.mes.options[2].value="01";		
    		}else{
    			
    			forma.mes.options[0]= new Option();
    			forma.mes.options[0].text="12";
    			forma.mes.options[0].value="12";
       			forma.mes.options[1]= new Option();
    			forma.mes.options[1].text="01";
    			forma.mes.options[1].value="01";
       			forma.mes.options[2]= new Option();
    			forma.mes.options[2].text="02";
    		...
    		if((mes-2)<10){
	    		...
	    		forma.mes.options[0].text=(mes-2);
	    		forma.mes.options[0].value=(mes-2);
	
	    	}	
			    	forma.mes.options[1]= new Option();
			
			    	if((mes-1)<10){
			    		forma.mes.options[1].text="0"+(mes-1);
			    		forma.mes.options[1].value="0"+(mes-1);
			
			    	}else{
			    			forma.mes.options[1].text=(mes-1);
			    			forma.mes.options[1].value=(mes-1);
			
			    	}	
			    	forma.mes.options[2]= new Option();
			
			    	if((mes)<10){
			    		forma.mes.options[2].text="0"+(mes);
			    		forma.mes.options[2].value="0"+(mes);
			
			    	}else{
			    			forma.mes.options[2].text=(mes);
			    			forma.mes.options[2].value=(mes);
...
//  Esta funcion es solo para Registro de consumos restringir mes.
  ...
  /*  function cargarPeriodoConsumo(periodo){
    	...
    	if(mes ==1 || mes ==2){
    		...
    		if(mes==1){
    	    	...
    	    	forma.ano.options[0].selected=true;
       			...
       			forma.mes.options[0]= new Option();
    			forma.mes.options[0].text="01";
    			forma.mes.options[0].value="01";
       			forma.mes.options[1]= new Option();
    			forma.mes.options[1].text="02";
    			forma.mes.options[1].value="02";	
    	 		forma.ano.options[0]=new Option();
    	    	forma.ano.options[0].text=(year);
    	    	forma.ano.options[0].value=(year);	
        	   	forma.ano.options[0].selected=true;
    	...
    	forma.mes.options[0].value="0"+(mes-1);
    		...
    		forma.mes.options[0].text=(mes-1);
    		forma.mes.options[0].value=(mes-1);

    	}	
    	forma.mes.options[1]= new Option();

    	if((mes-1)<10){
    		forma.mes.options[1].text="0"+(mes);
    		forma.mes.options[1].value="0"+(mes);

    	}else{
    			forma.mes.options[1].text=(mes);
    			forma.mes.options[1].value=(mes);

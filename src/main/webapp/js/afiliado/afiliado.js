...
function validarCampos() {
	...
	/*
	 * if (document.forms[0].email.value ==''){ alert('Ingrese su correo
	 * electronico'); return false; }
	 */
...
function abrirBuscarAfiliado() {
	...
	if (document.forms[0].numeroDistribuidor.value == '') {
		...
		ventaEmergente = window.open("BuscadorAfiliado?distribuidor="
				+ document.forms[0].numeroDistribuidor.value, "buscarAfiliado",
...
function buscarAfiliadoConsumo() {
	...
	if (document.forms[0].codigoEmpresario.value != '') {
		document.forms[0].documento.value = document.forms[0].codigoEmpresario.value
				+ "-"
				+ document.forms[0].letra.options[document.forms[0].letra.selectedIndex].value;
	}
...
function abrirBuscarDistribuidor() {
	...
	ventaEmergente = window.open("BuscadorDistribuidor", "buscarAfiliado",
			"scrollbars=yes,width=500,height=500");
...
function buscarDistribuidor() {
	...
	if (forma.codigoEmpresario.value != '') {
		forma.documento.value = forma.codigoEmpresario.value + "-"
				+ forma.letra.options[forma.letra.selectedIndex].value;
	}
	document.forms[0].submit();
...
function deshabilitarCuenta() {
	...
	seleccionarListaDesplegable(document.forms[0].bancoDistribuidor.value,
			document.forms[0].entidadBancaria);
	seleccionarListaChequeo(document.forms[0].tipoCuentaDistribuidor.value,
			document.forms[0].tipoCuenta);
...
function cargarCombosAfiliado(departamento, departamentoResidencia,
		tipoDocumento, estadoCivil, banco) {
	seleccionarListaDesplegable(departamento, document.forms[0].departamento);
	seleccionarListaDesplegable(departamentoResidencia,
			document.forms[0].departamentoResidencia);

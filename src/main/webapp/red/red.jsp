...
Código de la red: <input name="red" type="text" size="4" maxlength="4" />

Nombre de la red: <input name="nombreRed" type="text" size="25" maxlength="50" />
</div>
<br>

<div align="center">
	FORMULARIO DE INSCRIPCIÓN E INFORMACIÓN COMERCIAL DEL PRIMER AFILIADO DE LA RED
</div>
<div align="left" >
...
<div id="accordion">
  ...
  <table width="100%"  >
    <tr align="left">
      <td width="20%">Nombre:
      <input name="nombre" type="text" size="20"  maxlength="15"/></td>
      <td width="25%">Apellidos Completos:
        <input name="apellido" type="text" size="15"  maxlength="24"/></td>
      <td width="22%">Fecha de Nac: 
        <input name="fechaNacimiento" type="text" class="ui-datepicker-calendar" id="fecha" size="10" maxlength="10" /></td>
      <td colspan="2">Identificación:<br>
      
        <select name="tipoDocumento">
          <option value="C.C.">C.C.</option>
          <option value="Nit">Nit</option>
        </select>
         <input name="numeroIdentificacion" type="text" size="10" maxlength="13" /> de
<input name="de" type="text" size="15" />
       </td>
    </tr>
    <tr align="left">
      <td>
     ...
     <option value="<c:out value='${dept.descripcion}'/>"><c:out value='${dept.descripcion}'/></option>
      ...
      <td width="18%">Estado Civil:
       ...
       <input name="nombreConyugue" type="text" size="15" maxlength="50" />
      </td>
    </tr>
    ...
    <tr align="left">
      ...
      <td align="left">C.c:
        <input name="documentoConyugue" type="text" size="20"  maxlength="13" /></td>
    <td height="24" colspan="2">Dirección Resid. (completa):
  ...
  <tr>
    ...
    <tr>
      ...
      Tipo de cta.  Ahorro 
		...
		Ciudad:
		<input name="ciudadCuenta" type="text" size="10" maxlength="20" />
	 </td>
    </tr>
    <tr>
     ...
     <tr>
      <td>
        ...
        <tr>
         <td colspan="2">Autorizo que las bonificaciones generadas en mi red de ALOE de COLOMBIA sean consignadas en esta cuenta.
 		</td>
        </tr>  
  </table></div>
	<h3><a href="#">DATOS DEL DISTRIBUIDOR</a></h3>
	<div id="datosPatrocinador">

      <input name="nombrePatrocinador" type="hidden" />
      <input name="numeroEmpresario" type="hidden" />
...
<table width="917" align="left" >
  <tr>
    <td align="left">Nombres y Apellidos del distribuidor
     ...
     <tr>
      <td align="left">
      Codigo de Empresario(Distribuidor): <input name="numeroDistribuidor"  value="<c:out value='${usuario.cedula}'/>" type="text" size="15" maxlength="13" readonly="readonly" onclick="javascript:document.forma.numeroEmpresario.readOnly =true;"/> <a href="javascript:abrirBuscarDistribuidor()" >Buscar Distribuidor</a>
      <input type="hidden" name="numeroCuentaDistribuidor" value="<c:out value='${usuario.cuentaNro}'/>">
         ...
         <input type="hidden" name="ciudadCuentaDistribuidor" value="<c:out value='${usuario.ciudadCta}'/>"> 

			...
			<form name="liquidacion" method="post" action="ControlLiquidacion">
				...
				<div class="btn-group">
					<a class="btn btn-sm btn-default"
						href="javascript:generarReporteCompensacionRed();">Generar
						Reporte</a>
				</div>
				<table align="center" class="tbl-lista" width="80%">
					<tr>
						<th colspan="2">Consulta Lista de compensacion del
							distribuidor por Periodo</th>
					</tr>
					<tr>
						<td colspan="2">Distribuidor a consultar: <select
							name="distribuidor">
						...
						</select> Periodo: <select name="mes">
					...
					<tr>
						...
						<td align="left">¿Imprimir detalle? <input type="checkbox"
							name="detalle" value="true">
						</td>
					</tr>
				</table>
			</form>

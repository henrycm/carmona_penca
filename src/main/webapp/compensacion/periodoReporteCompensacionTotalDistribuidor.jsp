...
<body class="fondo" onload="javascript:cargarPeriodo('<c:out value="${periodo}"/>')">
 ...
 <div align="right" id="opcion">
		<a href="javascript:generarReportePeriodoTotalDistribuidor();">Generar Reporte</a>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</div>
 ...
 <div class="demo" align="center">
    <div class="titulo">Consultar consolidados de compensacion por periodo y distribuidor</div>

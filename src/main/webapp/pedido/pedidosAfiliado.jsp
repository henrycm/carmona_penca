...
<table width="80%" >
  ...
  <c:forEach var='producto'   items='${listaAlimentos}'>
    ...
    <td><input maxlength="3" size="3" name="cantidad_<c:out value='${producto.codigo}'/>_<c:out value='${producto.precioDistribuidor}'/>_<c:out value='${producto.nombreProducto}'/>"></input></td>
...
<table width="80%">
  ...
  <tr>
    ...
    <td><c:out value='${producto1.precioAfiliado}'/></td>
    <td><input name="cantidad_<c:out value='${producto1.codigo}'/>_<c:out value='${producto1.precioAfiliado}'/>_<c:out value='${producto1.nombreProducto}'/>"></input></td>
...
<table width="80%" >
  ...
  <tr>
    ...
    <td><c:out value='${producto.nombreProducto}'/></td>
    <td><c:out value='${producto.precioAfiliado}'/></td>
    <td><input name="cantidad_<c:out value='${producto.codigo}'/>_<c:out value='${producto.precioAfiliado}'/>_<c:out value='${producto.nombreProducto}'/>"></input></td>
    <td><input type="checkbox" value="<c:out value='${producto.codigo}'/>" name="producto" />
    </td>
    </tr>
</c:forEach>

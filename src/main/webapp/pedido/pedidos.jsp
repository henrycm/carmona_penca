...
<table width="80%" >
  ...
  <tr>
    ...
    <td><input maxlength="3" size="3" name="cantidad_<c:out value='${producto.codigo}'/>_<c:out value='${producto.precioDistribuidor}'/>_<c:out value='${producto.nombreProducto}'/>"  onclick="javascript:chequearProducto(this)"/></td>
    <td><input type="checkbox" value="<c:out value='${producto.codigo}'/>" name="producto"  />
    </td>
</c:forEach>
...
<table width="80%">
  ...
  <tr>
    ...
    <td><input name="cantidad_<c:out value='${producto1.codigo}'/>_<c:out value='${producto1.precioDistribuidor}'/>_<c:out value='${producto1.nombreProducto}'/>" onclick="javascript:chequearProducto(this)"/></td>
    <td><input type="checkbox" value="<c:out value='${producto1.codigo}'/>" name="producto" />
    </td>
    </tr>
</c:forEach>
...
<table width="80%" >
  ...
  <tr>
    ...
    <td><c:out value='${producto.nombreProducto}'/></td>
    <td><c:out value='${producto.precioDistribuidor}'/></td>
    <td><input name="cantidad_<c:out value='${producto.codigo}'/>_<c:out value='${producto.precioDistribuidor}'/>_<c:out value='${producto.nombreProducto}'/>" onclick="javascript:chequearProducto(this)"/></td>
    <td><input type="checkbox" value="<c:out value='${producto.codigo}'/>" name="producto" />
    </td>
    </tr>
</c:forEach>
